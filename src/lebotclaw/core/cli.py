...
# 对话风格选项
_STYLE_OPTIONS = [
    {"name": "warm", "label": "温柔耐心型", "desc": "像暖心伙伴一样，慢慢引导，多多鼓励",
     "extra": "你说话温暖有耐心，是让人安心的同龄伙伴（记住你是 15 岁男孩）。多用「没关系」「慢慢来」「你已经很棒了」这样的语气。"},
    {"name": "lively", "label": "活泼有趣型", "desc": "像好朋友一样，用有趣的例子和比喻",
     "extra": "你说话活泼有趣，像同学中的好朋友。多用比喻和生活中的小例子，偶尔用感叹号表达惊喜。"},
    {"name": "serious", "label": "严谨认真型", "desc": "思路清晰，条理分明，重点明确",
     "extra": "你说话认真有条理，思路清晰、重点明确，用编号列出关键步骤，但语气仍是同龄伙伴而不是老师。"},
]
...
def create_default_registry(model_adapters=None, default_model=None, memory=None, style_extra="", wiki=None, user_dir=None):
    ...
    if user_dir:
        ...
        _wb = lambda: WordBankTool(store=JsonListStore(f"{user_dir}/wordbank.json"))
    else:
        _mb, _wb = MistakeBookTool, WordBankTool
